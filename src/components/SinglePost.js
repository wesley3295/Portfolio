  ...
  return (
    <main className="bg-gray-200 min-h-screen p-12">
        <article className="container shadow-lg mx-auto bg-green-100 rounded-lg">
            ...
            <div className="px-16 lg:px-48 lg:py-12 prose lg:prose-xl max-w-full">BLOCK CONTENT</div>
            <BlockContent blocks={singlePost.body} projectId="ip32ox8w" dataset="production"/>
        </article>
    </main>
  );
};
